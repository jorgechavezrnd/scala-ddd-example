...
/**
  * View usage: runMain tv.codely.shared.infrastructure.environment.DbTablesCreator --usage
  * Execute: runMain tv.codely.shared.infrastructure.environment.DbTablesCreator
  */
